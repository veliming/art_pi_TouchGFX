    ...
    sliderValueChangedCallback(this, &MainViewBase::sliderValueChangedCallbackHandler)
{
    ...
    graphMajorXAxisLabel.setLabelTypedText(touchgfx::TypedText(T___SINGLEUSE_B423));
    ...
    graphMajorYAxisLabel.setLabelTypedText(touchgfx::TypedText(T___SINGLEUSE_Y8CC));
